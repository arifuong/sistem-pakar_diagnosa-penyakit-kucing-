...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 6rem; font-weight: 700; color: #4e73df; }
        .error-msg { font-size: 1.3rem; color: #666; margin-bottom: 1rem; }
...
<body>
    <div class="auth-wrapper">
        <div class="error-box">
            ...
            <p class="text-muted mb-4">Mungkin halaman telah dipindahkan atau URL yang Anda masukkan salah.</p>
